  ...
  return (
    <div className="max-w-sm mx-auto py-10 space-y-6">
      ...
      <button
        ...
        className="w-full py-3 px-4 rounded-xl border border-border bg-surface-alt hover:bg-surface text-ink font-semibold text-sm flex items-center justify-center gap-3 transition-all hover:scale-[1.01] hover:shadow-md active:scale-[0.99]"
      >
